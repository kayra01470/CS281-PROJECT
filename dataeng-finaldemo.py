...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  2 21:12:03 2024
...
def window_discussions():
    ...
    layout = [[sg.Listbox(discussion, size=(40,10), key='discussion'), sg.Combo(shows,default_value='interstellar 1',key='show'),sg.Button('Filter')],
...
def control_these_discussions(values):
    ...
    if show == '':
        ...
        layout = [[sg.Listbox(discussion, size=(40, 10), key='discussion')],
...
def control_these_comments(values):
    ...
    if show == ' ':
        ...
        layout = [[sg.Listbox(comment, size=(40, 10), key='comment')],
